...
FROM ${BASE_REGISTRY}/python:3.13.9-slim-trixie AS build-image
...
FROM ${BASE_REGISTRY}/python:3.13.9-slim-trixie AS app
...
USER  appuser
COPY --chown=appuser src/dataset_format_benchmark ./dataset_format_benchmark/
